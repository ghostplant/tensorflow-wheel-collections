### Provide Tensorflow-GPU prebuild Linux binaries and autobuild Dockerfile for CUDA 8.0/9.2 and CUDNN 6.0/7.1 which is not provided by official Tensorflow prebuild repository.
